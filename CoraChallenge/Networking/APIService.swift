...
final class AppService {
    ...
    private let listService: BankListServiceProtocol
    private var token: String?

    init(authService: AuthServiceProtocol, listService: BankListServiceProtocol) {
    ...
    func fetchList() async -> Result<[ListItem], NetworkError> {
